    ...
    <div class="migas">
        ...
        <div class="formatos col-sm-9 col-md-12 " >    
            <div class="conteiner">
                ...
                <video width="100%" height="80%" controls  poster="{{URL::asset('media/img/portada_outlook.JPG')}}">>
                    <source src="{{URL::asset("media/descargables/Manual OWAv2.mp4")}}" type="video/mp4">                
