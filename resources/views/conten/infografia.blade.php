...
@section('content')
    ...
    <a href="{{url("media\descargables\infografia_manual_soporte_tecnico_8.pdf")}}">
        <div class="formatos col-sm-9 col-md-12">            
            <i class="bi bi-file-earmark-medical"></i> - Manual de Agente de Sistemas  
            
        </div>
        </a>
        <a href="{{url("media\descargables\infografia_manual_soporte_tecnico_9_1.pdf")}}">
        <div class="formatos col-sm-9 col-md-12">
            
            <i class="bi bi-file-earmark-medical"></i> - Manual de Soporte Técnico / Infraestructura para Mesa de Servicio 
        </div>
        </a>
        <a href="{{url("media\descargables\infografia_manual_Usuario_7_1.pdf")}}">
        <div class=" formatos col-sm-9 col-md-12">
