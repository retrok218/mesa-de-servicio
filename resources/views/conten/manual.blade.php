...
@section('content')
    ...
    <a href="{{url("media\descargables\manual-de-cambio-de-contrasena-09052019.pdf")}}">
        <div class="formatos col-sm-9 col-md-12">            
             <i class="bi bi-book"></i> - Cambio de Contraseña de Correo Electrónico. 
            
        </div>
        </a>
        <a href="{{url("media\descargables\configuracion-de-correos-electronicos-en-microsoft-outlook-20166.pdf")}}">
        <div class="formatos col-sm-9 col-md-12">
        ...
        <a href="{{url("media\descargables\configuracion-de-correos-electronicos-en-microsoft-outlook-20076.pdf")}}">
        <div class=" formatos col-sm-9 col-md-12">
        ...
        <a href="{{url("media\descargables\manual-para-respaldo-de-correos-electronicos-por-medio-de-outlook-de-escritorio1.pdf")}}">
        <div class="formatos col-sm-9 col-md-12">
        ...
        <a href="{{url("media\descargables\manual-para-la-creacion-de-reglas-para-guardar-correos-electronicos-en-la-pc1.pdf")}}">
        <div class="formatos col-sm-9 col-md-12">
