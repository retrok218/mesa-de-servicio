...
@section('content')
    ...
    <a href="{{ url("public\media\descargables\Formato alta en cualquier sistema_3.xlsx")}}">
        <div class="formatos col-sm-9 col-md-12">            
             <i class="bi bi-file-earmark-text"></i> - Formato de Alta de Usuario en Cualquier Sistema             
        </div>
    </a>
    <a href="{{url("public\media\descargables\Solicitud claves para el acceso al Sistema de Control de Gestion_11.xlsx")}}">
        <div class="formatos col-sm-9 col-md-12">            
            <i class="bi bi-file-earmark-text"></i> - Solicitud claves para el acceso al Sistema de Control de Gestión                    
        </div>
        </a>
        <a href="{{url("public\media\descargables\Formato_Solicitud de Cuenta de Correo Electronico Personal_1.xlsx")}}">
        <div class=" formatos col-sm-9 col-md-12">            
            <i class="bi bi-file-earmark-text"></i> - Solicitud de Cuenta de Correo Electrónico Personal 
            
        </div>
        </a>
        <a href="{{url("public\media\descargables\Solicitud de Cuenta de Correo Masivo.xlsx")}}">
        <div class="formatos col-sm-9 col-md-12">
        ...
        <a href="{{url("public\media\descargables\Formato_Solicitud de Cuenta de Correo Electronico de Area_1.xlsx")}}">
        <div class="formatos col-sm-9 col-md-12">
        ...
        <a href="{{url("public\media\descargables\Formato-para-actualizar-informacion-de-cuenta-de-email-personal1.xlsx")}}">
            <div class=" formatos col-sm-9 col-md-12">
             <i class="bi bi-file-earmark-text"></i> - Formato para actualizar información de cuenta de e-mail (personal) 
            </div>
        </a>

        <a href="{{url("public\media\descargables\Formato_Solicitud de Baja Cuenta de Correo Electronico.xlsx")}}">
        <div class="formatos col-sm-9 col-md-12">
        ...
        <a href="{{url("public\media\descargables\usuario_vpn.pdf")}}">
        <div class="formatos col-sm-9 col-md-12">
        ...
        <a href="{{url("public\media\descargables\Formato_Alta_Usuarios_Externo.pdf")}}">
        <div class=" formatos col-sm-9 col-md-12">
        ...
        <a href="{{url("public\media\descargables\Formato de Alta de Usuario a la Mesa de Servicio_7.xlsx")}}">
        <div class=" formatos col-sm-9 col-md-12">
        ...
        <a href="{{url("public\media\descargables\Formato-de-solicitud-de-soporte-tecnico_5.xlsx")}}">
        <div class="formatos col-sm-9 col-md-12">
        ...
        <a href="{{url("public\media\descargables\Formato-de-solicitud-de-redes_6.xlsx")}}">
        <div class=" formatos col-sm-9 col-md-12">            
        <i class="bi bi-file-earmark-text"></i> - Formato de Solicitud de Redes
         
        </div>
        </a>
        <a href="{{url("public\media\descargables\Formato-de-solicitud-de-Infraestructura.xlsx")}}">
        <div class="formatos col-sm-9 col-md-12">            
